...
export function ProductCard({
  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-sm shadow-black/3 transition-all hover:-translate-y-1 hover:shadow-lg">
      <div className="relative m-3 mb-0 h-40 overflow-hidden rounded-xl bg-brand-light">
        ...
        <a
          ...
          title={orderLabel}
          className="absolute right-2 top-2 flex h-9 w-9 items-center justify-center rounded-full bg-white text-brand-dark shadow-md transition-colors hover:bg-brand-dark hover:text-white"
        >
